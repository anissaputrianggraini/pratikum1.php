...
<body>
<div class=" p-5" style="background-color: magenta;">
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body ">
            <form method="GET" action="form_nilai.php">
              ...
              <input type="submit" value="Simpan" name="proses" style="background-color: magenta">
            </form>
          </div>
        </div>
      ...
      <div class="col-md-4 mt-3">
        <div class="card">
          <div class="card-header text-white" style="background-color: magenta;">
            <h5>Hasil</h5>
          </div>
