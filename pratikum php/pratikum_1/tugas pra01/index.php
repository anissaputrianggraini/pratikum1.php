    ...
    <div class="row mx-1">
        <div class="col-md-6 mt-3">
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="submit" class="btn btn-magenta" value="SIMPAN" name="proses">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-footer" style="background-color: magenta;">
        ...
        <div class="col-md-6 mt-3">
            <table class="table table-bordered table-striped table-hover table-responsive">
                <thead>
                    <tr class="text-center text-white " style="background-color: magenta;" >
